...
export const projectArray: ProjectItemProps[] = [
  {
    ...
    title: 'Планируется запуск проекта',
    description: 'Сильный проект о котором узнает большая часть населения РФ',
    hint: 'Планируется запуск проекта, о котором узнает большая часть населения РФ',
    created: 2026,
  },
  {
