...
export const AboutMock: AboutItem[] = [
  {
    ...
    description:
      'Я Frontend-разработчик с почти трехлетним опытом работы в создании интерактивных пользовательских интерфейсов. Я специализируюсь на React и TypeScript, имею опыт использования Redux, Redux-Saga, также изучаю Mobx, для управления состоянием приложений и уверенно работаю с такими инструментами, как Webpack, Vite, Tailwind CSS, ShadCN.',
